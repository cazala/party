...
import {
  ...
  SpawnConfig,
  SpawnControlsRef,
} from "./control-sections/SpawnControls";
import {
  EmitterControls,
  EmitterConfig,
  EmitterControlsRef,
} from "./control-sections/EmitterControls";
import {
  InteractionControls,
  InteractionControlsRef,
} from "./control-sections/InteractionControls";
import {
  RenderControls,
  RenderControlsRef,
} from "./control-sections/RenderControls";
import {
  PerformanceControls,
  PerformanceControlsRef,
} from "./control-sections/PerformanceControls";
...
export const SystemControls = forwardRef<
  SystemControlsRef,
  SystemControlsProps
>(
  (
    ...
    return (
      <div className="controls-panel">
        ...
        <CollapsibleSection
          title="Emitters"
          tooltip="Place emitters that spawn particles continuously"
        >
          <EmitterControls

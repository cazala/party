...
struct VertexOutput { @builtin(position) position: vec4<f32>, @location(0) uv: vec2<f32>, @location(1) color: vec4<f32>, @location(2) @interpolate(flat) index: u32 }
...
@fragment fn fs_main(@location(0) uv: vec2<f32>, @location(1) color: vec4<f32>, @location(2) @interpolate(flat) index: u32, @builtin(position) frag_coord: vec4<f32>) -> @location(0) vec4<f32> ${fragment}`;
